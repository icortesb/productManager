...
routerProducts.delete('/:id', authRole('premium'), productManager.deleteProduct); // Modificar middleware para que premium solo pueda borrar productos que le pertenecen y admin pueda borrar cualquier producto
